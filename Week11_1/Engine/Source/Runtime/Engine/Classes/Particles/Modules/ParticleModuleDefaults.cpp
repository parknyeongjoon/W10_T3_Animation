...
const FVector ParticleModuleDefaults::Velocity::LinearVelocity = FVector(10.f, 0.f, 0.f);
...
const FVector ParticleModuleDefaults::Size::Min = FVector(1, 1, 1);
const FVector ParticleModuleDefaults::Size::Max = FVector(10, 10, 10);