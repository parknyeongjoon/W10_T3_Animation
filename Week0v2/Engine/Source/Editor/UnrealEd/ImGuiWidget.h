...
struct FImGuiWidget
{
    ...
    static bool DrawRot3Control(const std::string& label, FRotator& values, float resetValue, float columnWidth)
    {
        ...
        ImGui::SameLine();
        bValueChanged |= ImGui::DragFloat("##X", &values.Roll, 0.1f, 0.0f, 0.0f, "%.2f");
        ImGui::PopItemWidth();
        ImGui::SameLine(0, 5);
        ...
        ImGui::SameLine();
        bValueChanged |= ImGui::DragFloat("##Y", &values.Pitch, 0.1f, 0.0f, 0.0f, "%.2f");
        ImGui::PopItemWidth();
        ImGui::SameLine(0, 5);
        ...
        ImGui::SameLine();
        bValueChanged |= ImGui::DragFloat("##Z", &values.Yaw, 0.1f, 0.0f, 0.0f, "%.2f");
        ImGui::PopItemWidth();
